...
RcppExport SEXP _plmix_dp_normal_mix(SEXP xSEXP, SEXP NSEXP, SEXP alphaSEXP, SEXP lambdaSEXP, SEXP kappaSEXP, SEXP nuSEXP, SEXP OmegaSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_plmix_dp_normal_mix", (DL_FUNC) &_plmix_dp_normal_mix, 7},
    {NULL, NULL, 0}
};
